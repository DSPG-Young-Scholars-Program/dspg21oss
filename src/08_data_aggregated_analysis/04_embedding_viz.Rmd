...
p1 <- ggplot(filter(bert_embeddings_label, software_type %in% c("app_blockchain", "topics_dataviz")), aes(x = x, y = y)) + 
  geom_point()  + 
...
p2 <- ggplot(filter(bert_embeddings_label, software_type %in% c("app_blockchain", "topics_dataviz")), aes(x = y, y = z)) + 
  geom_point()  + 
  aes(colour = software_type) + 
  theme(legend.position = "top") + 
  labs(title = "Embeddings of repos classified as Blockchain and Data Visualization", 
